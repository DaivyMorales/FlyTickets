  ...
  return (
    <div className="flex h-screen w-screen items-center justify-center bg-zinc-800">
      ...
      <form
        ...
        className="flex  max-w-sm flex-col justify-center items-center w-[500px] gap-4 rounded p-6"
      >
        <PiAirplaneFill size={30} className="text-blue-500"/>
        ...
        <div className="flex items-center justify-between w-full">
          <button type="submit" className="btn w-full text-xs bg-blue-700">
            Ingresar
          </button>
        </div>
