...
export default function OriginInput() {
  ...
  return (
    <div className="relative w-full">
      <label className="input w-full bg-zinc-900 relative rounded-l-md">
      ...
      {isOpen && (query.length > 1 || loading) && (
        <div className="absolute mt-1 w-full border-[1px] border-zinc-700 rounded-b-md bg-zinc-800 shadow-lg max-h-60 overflow-auto z-10">
          {loading && (
            <div className="px-4 py-2 text-xs font-bold text-white">Cargando...</div>
          )}
          {!loading &&
